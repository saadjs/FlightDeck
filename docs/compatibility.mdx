...
This branch incorporates AeroSpace [`v0.21.2-Beta`](https://github.com/nikitabobko/AeroSpace/releases/tag/v0.21.2-Beta). FlightDeck retains its own app bundle, signing identity, Homebrew cask, and GitHub release tag; its build version uses the same numeric version as the corresponding AeroSpace release.
