...
This branch incorporates AeroSpace [`v0.21.2-Beta`](https://github.com/nikitabobko/AeroSpace/releases/tag/v0.21.2-Beta). FlightDeck retains its own app bundle, signing identity, Homebrew cask, and GitHub release tag. Its macOS app version uses the corresponding numeric version (`0.21.2`); the beta status is represented by FlightDeck's distinct prerelease tag and `flightdeck-beta` cask.
