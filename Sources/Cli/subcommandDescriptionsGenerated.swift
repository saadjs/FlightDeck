...
let subcommandDescriptions = [
    ...
    ["  config", "Query FlightDeck config options"],
    ...
    ["  eval", "Send multiple FlightDeck commands at once"],
    ...
    ["  subscribe", "Subscribe to FlightDeck events and receive notifications via socket"],
    ...
    ["  run-callback", "Run FlightDeck config callbacks on demand"],
