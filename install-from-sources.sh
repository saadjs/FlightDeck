...
brew list flightdeck > /dev/null 2>&1 && brew uninstall flightdeck
...
rm -rf /tmp/flightdeck-from-sources-brew-cache
HOMEBREW_CACHE=/tmp/flightdeck-from-sources-brew-cache brew install-path ./.release/flightdeck-dev.rb
